...
/**
 * Apache LevenshteinDistance implementation. For quantifying similarity of String values
 */
public class LevenshteinDistance {
  ...
  public static int getLevenshteinDistance(String s, String t) {
     ...
     * retain the previous cost counts as required by the algorithm (taking the minimum of the cost
     * count to the left, up one, and diagonally up and to the left of the current cost count being
     * calculated). (Note that the arrays aren't really copied anymore, just switched...this is clearly
     * much better than cloning an array or doing a System.arraycopy() each time through the outer
     * loop.)
     * 
