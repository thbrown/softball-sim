...
public class SoftballSim {
  ...
  public static final int NAME_PADDING = 24; // Just for formatting verbose
                                             // output
  public static final String STATS_FILE_PATH = System.getProperty("user.dir") + File.separator
      + "stats";
  ...
  public static void printAvailableLineupTypes() {
    ...
    for (Integer i : LINEUP_TYPES.keySet()) {
      System.out.println("\t\t" + i + ") "
          + LINEUP_TYPES.get(i).getLineupGenerator().getClass().getSimpleName());
    }
  }
