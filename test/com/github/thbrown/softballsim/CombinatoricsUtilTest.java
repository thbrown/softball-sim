...
public class CombinatoricsUtilTest {
  ...
  public void permutationRoundTrip() {
    ...
    for (int i = 0; i < CombinatoricsUtil.factorial(length); i++) {
      ...
      long rank = CombinatoricsUtil.getPermutationIndex(permutation);
  ...
  public void getOrderOfElementsInList() {
    List<String> original = Arrays.asList(new String[] {"B", "A", "F", "D", "E", "C"});
    List<String> shuffled = Arrays.asList(new String[] {"A", "B", "C", "D", "E", "F"});

    int[] order = CombinatoricsUtil.getOrdering(original, shuffled);
