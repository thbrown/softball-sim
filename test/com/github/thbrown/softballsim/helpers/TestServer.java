 ...
 * application expects to receive information in this manner when it is started and the 'NETWORK'
 * options is supplied as an argument for with the -s flag.
 */
public class TestServer implements Runnable {
  ...
  public static void runSimulationOverNetwork(ProcessHooks sm, boolean invokeCleanupScript) {
    try {
      ...
      SoftballSim.main(new String[] {"-o", "0", "-d", "NETWORK", "-l", "127.0.0.1", "-i", "0000000000", "-c",
          String.valueOf(invokeCleanupScript)});
    } catch (Exception e) {
      throw new RuntimeException(e);
    }
  }
