...
public class MonteCarloExhaustiveTest {
  ...
  public void testDataSourceFileSystem() throws Exception {
     ...
     * "1OiRCCmrn16iyK,Oscar,Molly,Nelly,1CV6WRyspDjA7Z,1MPJ24EEyS0g6p -y ./stats", "-G",
     * String.valueOf(GAMES), "-I", String.valueOf(INNINGS), "-t", String.valueOf(LINEUP_TYPE), "-T",
     * String.valueOf(THREAD_COUNT)};
     */
    String[] args = {
        "-l", "1OiRCCmrn16iyK,Oscar,Molly,Nelly,1CV6WRyspDjA7Z,1MPJ24EEyS0g6p", "-y", "./testData/testOptions.json",
